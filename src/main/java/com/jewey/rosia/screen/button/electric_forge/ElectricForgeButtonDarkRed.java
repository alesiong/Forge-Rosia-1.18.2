...
public class ElectricForgeButtonDarkRed extends Button {
    private final ElectricForgeBlockEntity forge;

    public ElectricForgeButtonDarkRed(ElectricForgeBlockEntity forge, int guiLeft, int guiTop, OnTooltip tooltip)
    {
        super(guiLeft + 64, guiTop + 69, 9, 7, Component.nullToEmpty("Temperature"), button -> {
    ...
    public void renderButton(PoseStack poseStack, int mouseX, int mouseY, float partialTick)
    {
        ...
        blit(poseStack, x, y, 64, 188, width, height, 256, 256);
