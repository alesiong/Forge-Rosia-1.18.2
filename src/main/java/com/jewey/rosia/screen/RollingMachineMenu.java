...
public class RollingMachineMenu extends AbstractContainerMenu {
    private final RollingMachineBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public RollingMachineMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }
    public RollingMachineMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.ROLLING_MACHINE_MENU.get(), pContainerId);
    ...
    public RollingMachineBlockEntity getBlockEntity() {
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.ROLLING_MACHINE.get());
    }
