...
public class RollingMachineScreen extends AbstractContainerScreen<RollingMachineMenu> {
    ...
    public RollingMachineScreen(RollingMachineMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void renderBg(PoseStack pPoseStack, float pPartialTick, int pMouseX, int pMouseY) {
        ...
        if(menu.isCrafting()) {
            blit(pPoseStack, leftPos + 85, topPos + 49, 176, 0, menu.getScaledProgress(), 17);
        }
