...
public class ElectricLoomScreen extends AbstractContainerScreen<ElectricLoomMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Rosia.MOD_ID, "textures/gui/electric_loom_gui.png");

    public ElectricLoomScreen(ElectricLoomMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
